...
CFLAGS			+=	$(shell [ `uname -s` = "Linux" ] && echo $(LINUX_FLAGS))
OBJS			= 	$(SOURCES:.c=.o)
TESTS_OBJS		= 	$(TESTS:.c=.o)
LOG				=	./build.log

.PHONY: all clean fclean re tests_run _tests_run \
...
# library
	...
	LIBRARY_SOURCES=$$(find $$LIBRARY_SOURCE_DIR -type f -name "*.c"); \
